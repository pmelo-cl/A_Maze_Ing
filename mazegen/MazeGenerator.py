...
class MazeGenerator:
    ...
    def generate(self, entry: Tuple[int, int],
        ...
        self._ensure_entry_exit_open(maze, entry_0, exit_0)
    ...
    def _ensure_entry_exit_open(self, maze: List[List[Cell]],
                                entry: Tuple[int, int],
                                exit_: Tuple[int, int]) -> None:
        """Abre las paredes en entrada y salida."""
        ex, ey = entry
        fx, fy = exit_
        self._open_boundary_wall(maze, ex, ey)
